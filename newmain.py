...
def initial_interface():
    ...
    while intro:
        ...
        button('Easy!', 80, 240, 80, 40, green, bright_green, game_loop, 'human')
        button('Hard!', 175, 240, 80, 40, green, bright_green, hard_game_loop, 'human')
...
def hard_game_loop(player, fps=20): #twice faster speed in the harder mode
    game.restart_game()
